...
include('koneksi.php');
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM books WHERE books.id = '$id' LIMIT 1");
...
<form class="container ms-5 mb-5" action="update.php" method="POST">
    ...
    <textarea name="cover" cols="30" rows="10"><?php echo $result[0]['cover'] ?></textarea>
    <br /><br />

    <label>Description</label><br />
    <textarea name="description" cols="30" rows="10"><?php echo $result[0]['cover'] ?></textarea>
    <br /><br />


    <label>Harga</label>
    <input type="number" name="harga" value="<?php echo $result[0]['harga']?>">
    <br/><br/>
